...
\Mode{System-modifikator}{
	...
	\BindKey{\Key{}{4}{7}}{\Cmd{xrand--auto; xrandr --output HDMI-1 --off --output eDP-1 --pos 0x0; wacom-config output 0}}
	\BindKey{\Key{}{4}{8}}{\Cmd{xrandr --auto; xrandr --output HDMI-1 --pos 0x0 --output eDP-1 --pos 2560x500; xsetwacom --set 10 MapToOutput  2560x1440+0+0; wacom-config output 0}}
