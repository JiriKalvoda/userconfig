...
\Mode{System-modifikator}{
	...
	\BindKey{\Key{}{4}{9}}{\Cmd{xrandr --auto }}
	\BindKey{\Key{}{4}{7}}{\Cmd{xrand--auto; xrandr --output HDMI-1 --off --output eDP-1 --pos 0x0}}
	\BindKey{\Key{}{4}{8}}{\Cmd{xrandr --auto; xrandr --output HDMI-1 --pos 0x0 --output eDP-1 --pos 2560x500}}
...
\BindKey{\KeyO{\Super}}{\Cmd{~/dev/pasman/client chrome}}
